...
import fusionCollectionImg from '../../images/fusion-header.jpeg'
...
const AlphaCollection = () => {
  ...
  */
  ...
  useEffect(() => {
    ...
    let nftData = {
      ...
      variables: {
        filters: {
          collectionSlug: "mad_vapes_fusion",
          nativeIds: [],
          ownerAddress: null,
  ...
  */
  ...
  return (
    <>
    <PageHeader slide={fusionCollectionImg} />
    <HeadStats title="Fusion Collection" info={collectionStats} />
        ...
        <Col sm={12} md={9}>
          <Row>
            <Col lg={12} xl={6} className="d-flex top-search">
              <h3 className='alpha'>Fusions({totalCount})</h3>
              <SearchElement
